...
function Filter({ onCategoryChange, search, onSearchChange }) {
  ...
  const handleSearch = (e) => onSearchChange(e.target.value) //Filter Deliverable #3
  ...
  return (
    <div className="Filter">
      <input 
        ...
        name="search" 
        placeholder="Search..." 
        //Filter Deliverable #2: Connect that state to the input field
        value={search}
...
Note: you may be asking yourself, why are we making this input controlled when the <select> element is not a controlled input? Well, the <select> input should probably be controlled as well! The tests don't require it, but feel free to update the <select> element to be a controlled element.
